...
//cheking tableData is empty
    ...
    table.innerHTML = "";
    for(var i=0; i<practiceData1.length; i++){
        var row = `
            <tr>
                <td>${practiceData1[i].number}</td>
                <td><a href="#">${practiceData1[i].code}</a></td>
                <td><a href="#">${practiceData1[i].title}</a></td>
                <td>${practiceData1[i].time}</td>
            </tr>`
        table.innerHTML += row;
    }
}
